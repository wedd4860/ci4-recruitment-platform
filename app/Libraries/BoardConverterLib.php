...
class BoardConverterLib
{
    ...
    public function setInputTag($input_name, array $var, $type, $code, $input_value): string
    {
        $data = '';
        $max_ = count($var);
        for ($i = 0; $i < $max_; $i++) {
    ...
    public function setSelectTag($input_name, array $var, $code, $input_value): string
    {
    ...
    public function getFileAccept(array $accept): string
    {
        $ext = [];
    ...
    public function setFileTag($input_name, $code, $key, $accept = null, $input_value): string
    {
        $data = '';
        ...
        if (is_array($input_value)) {
            ...
            foreach ($input_value as $key_ => $val) {
                $file = new File($_SERVER['DOCUMENT_ROOT'] . $val['path']);
    ...
    public function setAddressTag($input_name, $code, $key, $input_value): string
    {
    ...
    public function setInput(string $input_name = null, array $value = []): array
    {
        $data = [];
        $script = [];
        $editor_use = false;
